...
// MUDE APENAS ISSO PARA CADA PÁGINA
const serviceInfo = {
  title: "Desenvolvimento de Produto",
  description: "Transformamos ideias complexas em produtos prontos para manufatura, com foco em viabilidade técnica e financeira.",
};
